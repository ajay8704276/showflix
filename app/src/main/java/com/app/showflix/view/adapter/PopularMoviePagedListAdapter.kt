...
import com.app.showflix.view.activities.movie.PopularMovieDetailActivity
import com.bumptech.glide.Glide
import kotlinx.android.synthetic.main.movie_list_item.view.*
import kotlinx.android.synthetic.main.network_state_item.view.*

class PopularMoviePagedListAdapter(val context: Context) :
    PagedListAdapter<Results, RecyclerView.ViewHolder>(MovieDiffCallback()) {
    ...
    class MovieItemViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        fun bind(movie: Results?, context: Context) {
